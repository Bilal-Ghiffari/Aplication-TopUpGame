        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-4 text-lg-start text-center">
              ...
              <p className="mt-30 text-lg color-palette-8 mb-30">
            ...
            <div className="col-lg-8 mt-lg-0 mt-20">
              <div className="row gap-sm-0">
                <div className="col-md-4 col-6 mb-lg-0 mb-25">
                  <p className="text-lg fw-semibold color-palette-5 mb-12">
                    Company
                  </p>
                  <ul className="list-unstyled">
                    <LinkFooter
                      href=""
                      className="text-lg color-palette-8 text-decoration-none"
                      title="About Us"
                    />
                    <LinkFooter
                      href=""
